...
public class CatalogVehicleController {
    ...
    public ResponseEntity<List<Vehicle>> getVehiclesByModel(@PathVariable("category") char category){
    ...
    protected ResponseEntity<Vehicle>getVehiclesByModel(@PathVariable("state_number") String stateNumber){
